...
[pilltracker.pages.dev](https://pilltracker.pages.dev)에서 바로 사용할 수 있습니다. Cloudflare Pages를 통해 호스팅되고 있으며, 별도 설치 없이 브라우저에서 접속하면 됩니다.

보안 설정에서 암호화를 켜면 복용 기록은 브라우저에서 암호화된 후 서버에 저장됩니다. 복호화 키는 서버에 저장되지 않으므로, 서버 관리자도 암호화된 기록의 내용을 열람할 수 없습니다.
